                        ...
                        {stepsMeta.map((s) => (
                            <li key={s.id}>
                                <button
                                    ...
                                    className={`flex w-full items-center justify-between rounded-xl px-3 py-2 text-left transition ${step === s.id
                    ...
                    {step === 6 && result && (
                        <section className="space-y-6">
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-3 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
                                    ...
                                    <dl className="space-y-2 text-sm text-gray-700">
                                        ...
                                        <div className="flex justify-between">
                                            <dt className="text-gray-500">Substances used (last 30 days)</dt>
                                        ...
                                        {form.priorTreatment === "yes" && (
                                            <>
                                                <div className="flex justify-between">
                                                    <dt className="text-gray-500">Last treatment duration</dt>
                                                    <dd>{form.treatmentLastDuration}</dd>
                                                </div>

                                                <div className="flex justify-between">
                                                    <dt className="text-gray-500">Last treatment year</dt>
                                                    <dd>{form.treatmentLastYear}</dd>
                                                </div>

                                                <div className="flex justify-between">
                                                    <dt className="text-gray-500">Treatment facility</dt>
                                ...
                                <div className="space-y-3 rounded-2xl border border-indigo-100 bg-indigo-50/60 p-4 shadow-sm">
                                    <h2 className="text-sm font-semibold text-gray-900">
                                        Recommendation
                                    </h2>
                                    ...
                                    <dl className="space-y-2 text-sm text-gray-800">
                                        <div className="flex justify-between">
                                            <dt className="text-gray-600">Withdrawal risk</dt>
                                            <dd className="font-medium">{result.withdrawalRisk}</dd>
                                        </div>

                                        <div className="flex justify-between">
                                            <dt className="text-gray-600">Relapse risk</dt>
                                            <dd className="font-medium">{result.relapseRisk}</dd>
                                        </div>

                                        <div className="flex justify-between">
                                            <dt className="text-gray-600">Co-occurring needs</dt>
                                            <dd className="font-medium">{result.coOccurring}</dd>
                                        </div>

                                        <div className="flex justify-between">
                                            <dt className="text-gray-600">Support level</dt>
                                            <dd className="font-medium">{result.supportLevel}</dd>
                                        </div>

                                        <div className="flex justify-between">
                                            <dt className="text-gray-600">Recommended level of care</dt>
                                            <dd className="font-medium">
                            ...
                            <button
                                ...
                                disabled={loading || !form.initials.trim()}
                                className="inline-flex items-center justify-center rounded-xl bg-black px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-gray-900 disabled:cursor-not-allowed disabled:opacity-40"
                            >
