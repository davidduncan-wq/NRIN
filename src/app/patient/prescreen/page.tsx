...
export default function PreScreenPage() {
    ...
    const facilityName = searchParams.get("facilityName") || "Selected facility";
    const facilityLocation = searchParams.get("facilityLocation") || "";
    ...
    const intakeSelfPayIntent = searchParams.get("selfPayIntent") || "";
                    ...
                    <div className="space-y-6">
                        ...
                        {form.paymentPath === "insurance" && (
                            <SectionShell
                                ...
                                body="Step 5 gave us a soft signal. This is the ratification step, where we capture the specific plan needed for review."
                            >
                                ...
                                <div className="mt-4">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            update("insuranceCarrierName", e.target.value)
                                        }
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <div className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {["today", "this_week", "flexible"].map((opt) => (
                                            <ChoicePill
                                                key={opt}
                                ...
                                <div>
                                    <label className="mb-2 block text-sm font-medium text-slate-900">
                                        Any court or legal requirements?
                                    </label>
                                    <div className="flex flex-wrap gap-2">
                                        {["yes", "no"].map((opt) => (
                                            <ChoicePill
                                                key={opt}
                                                active={form.legalIssues === opt}
                                                label={opt}
                                                onClick={() => update("legalIssues", opt)}
                                            />
                                        ))}
                                    </div>
                                </div>
                        ...
                        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                            ...
                            <p className="mt-2 text-sm leading-6 text-slate-600">
                                Once this is ratified, NRIN will move the case into live placement operations.
                            </p>
                            ...
                            <button
                                ...
                                className="mt-5 inline-flex h-11 w-full items-center justify-center rounded-xl bg-black px-6 text-sm font-semibold text-white transition hover:bg-slate-900 disabled:opacity-40"
                            >
                                {loading ? "Submitting..." : "Finalize referral"}
                            </button>
                        </div>
                    </div>
                </div>
