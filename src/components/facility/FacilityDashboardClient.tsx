      ...
      <section className="mb-4 flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`${insurancePillBase} ${
              filterMedicaid ? insurancePillActive : insurancePillInactive
            }`}
          >
            Medicaid
          </button>
          <button
            ...
            className={`${insurancePillBase} ${
              filterPrivate ? insurancePillActive : insurancePillInactive
            }`}
          >
            Private insurance
          </button>
          <button
            ...
            className={`${insurancePillBase} ${
              filterSelfPay ? insurancePillActive : insurancePillInactive
            }`}
          >
            Self-pay
          </button>
