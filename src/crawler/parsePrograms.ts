...
const PROGRAM_PATTERNS: Record<string, RegExp[]> = {
  detox: [/\bdetox\b/i, /\bmedical detox\b/i, /\bwithdrawal management\b/i],
  residential: [/\bresidential\b/i, /\bresidential treatment\b/i, /\blive-?in treatment\b/i],
  outpatient: [/\boutpatient\b/i],
  php: [/\bpartial hospitalization\b/i, /\bpartial hospitalization program\b/i, /\bphp\b/i],
  iop: [/\bintensive outpatient\b/i, /\bintensive outpatient program\b/i, /\biop\b/i],
  op: [/\boutpatient program\b/i],
  dual_diagnosis: [/\bdual diagnosis\b/i, /\bco-occurring\b/i, /\bco occurring\b/i],
  mat: [
  ...
  sober_living: [/\bsober living\b/i, /\brecovery residence\b/i, /\btransitional living\b/i],
  family_program: [/\bfamily program\b/i, /\bfamily therapy\b/i, /\bfamily support\b/i],
  professional_track: [
